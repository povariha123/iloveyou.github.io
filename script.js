...
function drawText()
{
    ...
    if (frameNumber < 250)
    {
        ...
        context.fillText("я не могу поверить, как мне повезло", canvas.width/2, canvas.height/2);
    ...
    if (frameNumber > 500 && frameNumber < 750)
    {
        ...
        {
            drawTextWithLineBreaks(["встреча с тобой - ", "это лучшее событие в моей жизни"], canvas.width / 2, canvas.height / 2, fontSize, lineHeight);
        }
        else
        {
            context.fillText("встреча с тобой - это лучшее событие в моей жизни", canvas.width/2, canvas.height/2);
        }
    ...
    if (frameNumber >= 2750 && frameNumber < 99999)
    {
        ...
        context.fillText("мы с тобой будем самыми счастливыми", canvas.width / 2, (canvas.height / 2 + 50));
