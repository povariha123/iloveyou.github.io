...
function drawText()
{
    ...
    if (frameNumber > 2000 && frameNumber < 2250)
    {
        ...
        if (window.innerWidth < 600)
        {
            drawTextWithLineBreaks(["и все эти звёздочки для тебя,", "все 2202 звёздочки)"], canvas.width / 2, canvas.height / 2, fontSize, lineHeight);
        }
        else
        {
            context.fillText("и все эти звёздочки для тебя, все 2202 звёздочки)", canvas.width/2, canvas.height/2);
        }
